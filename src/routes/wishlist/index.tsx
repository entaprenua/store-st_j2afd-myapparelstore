import { WishlistItems, WishlistItemsView, WishlistItemsEmpty } from "~/components/ui/wishlist"
import { Product, ProductImage, ProductName, ProductPrice, ProductRemoveFromWishlistTrigger, ProductAddToCartTrigger } from "~/components/ui/product"
              ...
              <Flex gap={4} align="start" class="flex-wrap">
                <Product class="flex gap-4 flex-1 min-w-0">
                  ...
                  <div class="flex items-center gap-3">
                    ...
                    <ProductRemoveFromWishlistTrigger class="text-muted-foreground hover:text-destructive shrink-0" />
                  </div>
                </Product>
              </Flex>
            </div>
